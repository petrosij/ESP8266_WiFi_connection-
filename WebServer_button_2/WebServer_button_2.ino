...
void checkAndChangeState (long *, String);
      ...
      if (client.available()) {
        ...
        if (c == '\n' && currentLineIsBlank) {
         ...
         // client.println("Refresh: 5");  // refresh the page automatically every 5 sec
          ...
          client.println("  bikoagulation <button type=\"submit\" name=\"switchBikoag\" value=\"1\"> Switch ON </button>     ");
          client.println("  <button type=\"submit\" name=\"switchBikoag\" value=\"0\"> Switch OFF </button>     ");
          client.println(" </form>");
          client.println(" <form action=\"\">");
          client.println("  monokoagulation <button type=\"submit\" name=\"switchMonokoag\" value=\"1\"> Switch ON </button>     ");
          client.println("  <button type=\"submit\" name=\"switchMonokoag\" value=\"0\"> Switch OFF </button>     ");
          client.println(" </form>");
          client.println(" <form action=\"\">");
          client.println("  mono cutting <button type=\"submit\" name=\"switchMonocut\" value=\"1\"> Switch ON </button>     ");
          client.println("  <button type=\"submit\" name=\"switchMonocut\" value=\"0\"> Switch OFF </button>     ");
          client.println(" </form>");
...
void checkAndChangeState(long * state, String strToCheck){
  for (int i = 0;i<=endPosition;i++){
      if(str2.substring(i,endPosition).startsWith(SWITCHBIKOAG)){
       Serial.print("str2 is ");
       Serial.println(str2);
